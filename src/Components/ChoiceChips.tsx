...
export default function ChoiceChips<T extends string>({options, value, onChange, accessibilityLabel}: ChoiceChipsProps<T>) {
                ...
                return (
                    <Pressable
                        ...
                        <Text
                            ...
                            style={[styles.label, {color: selected ? colors.onAccent : colors.text, fontWeight: selected ? '700' : '600'}]}>
                            {option.label}
                        </Text>
                    </Pressable>
                );
