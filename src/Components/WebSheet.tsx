        ...
        <BottomSheet visible={visible} onClose={onClose} accessibilityLabel={title} testID={testID} tall={true}>
            <View style={[styles.header, {borderBottomColor: colors.divider}]}>
                ...
                <Pressable
                    ...
                    <Text maxFontSizeMultiplier={theme.maxFontScaleForLabels} style={[styles.closeText, {color: colors.accentText}]}>
                        Tanca
                    </Text>
                </Pressable>
            </View>
            <WebView
                ...
                renderError={() => state(
                    <Text style={[styles.error, {color: colors.text}]}>És necessari tenir una connexió a internet</Text>,
                )}
