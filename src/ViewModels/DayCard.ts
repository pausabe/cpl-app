...
const WEEKDAY_CELEBRATIONS: string[] = [
    CelebrationType.Festivity, CelebrationType.Memory,
    CelebrationType.OptionalMemory, CelebrationType.OptionalVirginMemory,
];
...
export function buildDayCard(day: DayInput, celebration: CelebrationInput, settings: PlaceAndOptionsInput): DayCard {
    ...
    return {
        ...
        optionalMemory: optional
            ? {enabled: !!settings.OptionalFestivityEnabled, caption: optionalMemoryCaption(!!settings.OptionalFestivityEnabled)}
            : null,
    };
}
