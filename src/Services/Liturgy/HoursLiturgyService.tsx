...
export async function ObtainHoursLiturgy(liturgyMasters: LiturgyMasters, liturgyDayInformation: liturgyDayInformation, settings: Settings) : Promise<HoursLiturgy> {
  ...
  hoursLiturgy.Vespers = GetVespersWithLowerPrecedence(liturgyMasters, liturgyDayInformation, celebrationHoursLiturgy.CelebrationInformation, settings, hoursLiturgy.VespersOptions);
