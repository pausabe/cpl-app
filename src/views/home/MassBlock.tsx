...
export default function MassBlock({ mass, onOpen, onChoose }: MassBlockProps) {
  ...
  const chip = [
    styles.chip,
    { backgroundColor: colors.chipBackground, borderColor: colors.border, minHeight: theme.touch.comfortable },
  ];
  ...
  return (
    <View style={styles.section}>
      ...
      <Card style={styles.card}>
        ...
        >
          <Text maxFontSizeMultiplier={scale} style={[styles.caption, { color: colors.text3 }]}>
            {mass.gospel.caption}
          </Text>
          {mass.gospel.phrase ? (
