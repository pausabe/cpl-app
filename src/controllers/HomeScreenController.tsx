...
export default function HomeScreenController({ navigation }: { navigation: any }) {
  ...
  const choice: MassChoice =
    massChoice && massChoice.day === todayKey
      ? massChoice.choice
      : choiceInput
        ? resolveMassChoice({ ...choiceInput, stored: null }).choice
        : 'normal';
  ...
  const onOpenHour = (tile: HourTile) =>
    navigation.navigate('LHDisplay', {
