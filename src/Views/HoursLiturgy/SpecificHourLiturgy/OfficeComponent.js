...
export default class OfficeComponent extends Component {
            ...
            if (this.today.SpecificLiturgyTime === SpecificLiturgyTimeType.EasterSunday) {
                ...
                return (
                    <View>
                        ...
                        <HR/>
                        <Gap/>
                        <SectionTitle>{"HIMNE"}{(this.today.SpecificLiturgyTime === SpecificLiturgyTimeType.Ordinary && this.hours.Office.IsDarkAnthem) ? " (nit)" : " (dia)"}</SectionTitle>
                        {this.himne()}
                        <Gap/>
                        <HR/>
                        <Gap/>
        ...
        return (
            <View>
                <ChoiceChips
                    ...
                    options={INVITATORY_PSALMS.filter((psalm) => psalm === '94' || GlobalViewFunctions.salmInvExists(psalm, this.titols))
    ...
    lectures() {
        try {
            ...
            const aux_cita_resp1 = aux_has_citaResp1 ? GlobalViewFunctions.rs(this.hours.Office.FirstReading.Responsory.Quote) : "";
            const aux_resp1_1_2 = GlobalViewFunctions.respTogether(GlobalViewFunctions.rs(this.hours.Office.FirstReading.Responsory.FirstPart), GlobalViewFunctions.rs(this.hours.Office.FirstReading.Responsory.SecondPart));
            ...
            const aux_has_cita2 = this.hours.Office.SecondReading.Quote != null && this.hours.Office.SecondReading.Quote !== '-';
            ...
            const aux_resp2_1_2 = GlobalViewFunctions.respTogether(GlobalViewFunctions.rs(this.hours.Office.SecondReading.Responsory.FirstPart), GlobalViewFunctions.rs(this.hours.Office.SecondReading.Responsory.SecondPart));
